...
public class CameraScript : MonoBehaviour
{
    ...
    [SerializeField] private float minPithAngle = 0.0f; // Minimun Pitch Angle;

    [SerializeField] private float maxPitchAngle = 90.0f; //Maximum Pitch Angle;

    [Header("Distance to Target")]
    [SerializeField] private float MIN_CAM_DIST = 3f;

    [SerializeField] private float MAX_CAM_DIST = 80f;
